        ...
        <div className="legals">
            <div className="body">
                ...
                <>
                    <h2>1. Terms</h2>
                    <p>
                        By accessing this website and all it's sub domains, accessible from https://heptagrambotproject.com, you are
                    ...
                    <p>
                        ...
                        Heptagram-Bot-Project's Website for personal, non-commercial transitory viewing
                    ...
                    <ul>
                        ...
                        <li>
                            attempt to reverse engineer any software contained on Heptagram-Bot-Project's
                            Website;
                        </li>
                        <li>
                    ...
                    <p>
                        This will let Heptagram-Bot-Project to terminate upon violations of any of these
                    ...
                    <p>
                        ...
                        Heptagram-Bot-Project makes no warranties, may it be expressed or implied, therefore
                        negates all other warranties. Furthermore, Heptagram-Bot-Project does not make any
                    ...
                    <h2>4. Limitations</h2>
                    <p>
                        Heptagram-Bot-Project or its suppliers will not be hold accountable for any damages
                        that will arise with the use or inability to use the materials on
                        Heptagram-Bot’s Website, even if Heptagram-Bot-Project or an authorize
                    ...
                    <p>
                        ...
                        typographical, or photographic errors. Heptagram-Bot-Project will not promise that
                        any of the materials in this Website are accurate, complete, or current.
                        Heptagram-Bot-Project may change the materials contained on its Website at any time
                        without notice. Heptagram-Bot-Project does not make any commitment to update the
                        materials.
                    </p>
                    <h2>6. Links</h2>
                    <p>
                        Heptagram-Bot-Project has not reviewed all of the sites linked to its Website and is
                        not responsible for the contents of any such linked site. The presence of
                        any link does not imply endorsement by Heptagram-Bot-Project of the site. The use of
                        any linked website is at the user’s own risk.
                    </p>
                    <h2>7. Site Terms of Use Modifications</h2>
                    <p>
                        Heptagram-Bot-Project may revise these Terms of Use for its Website at any time
                    ...
                    <p class="last">
                        Any claim related to Heptagram-Bot-Project's Website shall be governed by the laws
