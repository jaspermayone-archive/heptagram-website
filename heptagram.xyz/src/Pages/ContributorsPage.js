    ...
    return (
        <div className="devs">
            <HeaderDevs/>
                ...
                <main>
                    <div className="owner">
                        <img className="avatar" src="https://github.com/j-dogcoder.png" alt="j-dogcoder'a avatar"/>
                        <p className="name">Jasper Mayone (j-dogcoder)</p>
                        <p className="position">Owner</p>
                        <a href="https://github.com/j-dogcoder"><i className="fab fa-github" style={{color: '#2c2f33', transform: 'scale(1.5)'}}></i></a>
                    </div>
                    ...
                    <div className="head-developer second">
                        ...
                        <a href="https://github.com/Vyvy-vi"><i className="fab fa-github" style={{color: '#2c2f33', transform: 'scale(1.5)'}}></i></a>
                    </div>
                    <div className="developers">
                        ...
                        <div className="developer">
                            ...
                            <p className="position">Web Developer</p>
                            <a href="https://github.com/akzain"><i className="fab fa-github" style={{color: '#2c2f33', transform: 'scale(1.5)'}}></i></a>
                        </div>
                    </div>
